...
<html>
    ...
    <body>
        ...
        <content tag="nav">
            ...
            <li class="nav-item">       
                 <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Funcionário<span class="caret"></span></a>     
                 <ul class="dropdown-menu">        
                     <g:link controller="funcionario" action="create">Cadastrar</g:link> 
                     <g:link controller="aluguel" action="create">Alugue um carro</g:link>
                     <g:link controller="carro" action="create">Listar Carros</g:link>
                 </ul>     
             </li>
        </content>
